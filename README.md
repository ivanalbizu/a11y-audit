...
Aplicación web para gestionar auditorías de accesibilidad siguiendo el estándar **WCAG 2.2 nivel AA**. Permite crear, revisar y exportar auditorías completas con un checklist de **95 ítems** organizados en 7 áreas.

## Funcionalidades

- **Dashboard** — Vista general de todas las auditorías con progreso y estadísticas
- **Checklist interactivo** — 95 criterios de verificación con filtros por área, severidad, estado, tipo y nivel WCAG (A/AA/AAA)
...
src/
├── data/
│   ├── checklist.js    # 95 ítems del checklist WCAG 2.2
