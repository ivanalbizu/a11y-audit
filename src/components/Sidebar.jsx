      ...
      {audits.map(a => {
        ...
        return (
          <button key={a.id} onClick={() => onSelectAudit(a.id)}
            ...
            <div style={{ fontFamily:"'DM Mono',monospace", fontSize:"0.8rem", color: isActive ? "#E8FF47" : "#C0C0D0", marginBottom:"0.25rem", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
              {domain}
            </div>
